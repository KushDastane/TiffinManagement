// Indian States and Major Cities for Discovery Screen Filters
...
// Normalized states for comparison
export const NORMALIZED_STATES = INDIAN_STATES.map(state => normalizeLocation(state));
...
/**
 * Get normalized state name from display name
 * @param {string} stateDisplay - Display name of state
 * @returns {string} - Normalized state name
 */
export const getNormalizedState = (stateDisplay) => {
    return normalizeLocation(stateDisplay);
};

/**
 * Get normalized city name from display name
 * @param {string} cityDisplay - Display name of city
 * @returns {string} - Normalized city name
 */
export const getNormalizedCity = (cityDisplay) => {
    return normalizeLocation(cityDisplay);
};
